...
class LawyerSignup extends StatefulWidget{
  ...
  const LawyerSignup({super.key, required this.email, required this.name, required this.password});
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                          ...
                                          child: Padding(padding: const EdgeInsets.only(left: 30, right: 10),
